...
- Source: `https://github.com/unique379r/strspy` @ `f7e0897b8283cbf8cdae73c6a22b7b938dc8f377`
- Environment: ubuntu-22.04 (`Dockerfile`)
- Generated: 2026-09-20T12:51:40+00:00
...
- CI run: https://github.com/Tfronta/strhub-verified/actions/runs/35511747253
...
- Install method: [`setup/STRspy_2.0_env.yml`](https://github.com/unique379r/strspy/blob/f7e0897b8283cbf8cdae73c6a22b7b938dc8f377/setup/STRspy_2.0_env.yml)
- Run command: [`README.md` line 120](https://github.com/unique379r/strspy/blob/f7e0897b8283cbf8cdae73c6a22b7b938dc8f377/README.md#L120): `USAGE: bash ./STRspy_run_v2.0_Args.sh config/InputConfig.txt config/ToolsConfig.txt`
- Example data: [`db-v2/STRspy_v2.DB.sort.bed`](https://github.com/unique379r/strspy/blob/f7e0897b8283cbf8cdae73c6a22b7b938dc8f377/db-v2/STRspy_v2.DB.sort.bed)
- Example data: [`db-v2/optional-create-custom-db/testTwofa/TPOX.fa`](https://github.com/unique379r/strspy/blob/f7e0897b8283cbf8cdae73c6a22b7b938dc8f377/db-v2/optional-create-custom-db/testTwofa/TPOX.fa)
- Example data: [`db-v2/optional-create-custom-db/testTwofa/vWA.fa`](https://github.com/unique379r/strspy/blob/f7e0897b8283cbf8cdae73c6a22b7b938dc8f377/db-v2/optional-create-custom-db/testTwofa/vWA.fa)
- Known issue: [`README.md` line 291](https://github.com/unique379r/strspy/blob/f7e0897b8283cbf8cdae73c6a22b7b938dc8f377/README.md#L291): `Known bug`
- Documented input: [`README.md` line 44](https://github.com/unique379r/strspy/blob/f7e0897b8283cbf8cdae73c6a22b7b938dc8f377/README.md#L44): `Input either fastq (raw reads usually from ONT) or bam (pre-aligned reads by user)`
- Author's recommendation: [`README.md` line 295](https://github.com/unique379r/strspy/blob/f7e0897b8283cbf8cdae73c6a22b7b938dc8f377/README.md#L295): `***Tip: Its good practice to use pre-aligned bams for quicker outcomes.***`
